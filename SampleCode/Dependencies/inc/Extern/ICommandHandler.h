...
extern "C"
{
    ...
    VT_STOR_ATA_API void cCommandHandlerAsynIo_GetCommandHandler(std::shared_ptr<vtStor::ICommandHandler>& CommandHandler, std::shared_ptr<vtStor::IProtocol> Protocol);
