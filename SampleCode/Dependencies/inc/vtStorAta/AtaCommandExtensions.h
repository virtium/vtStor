...
namespace vtStor
{
    namespace Ata
    {
        ...
        const U8 ATA_COMMAND_READ_DMA_EXT = 0x25;
        const U8 ATA_COMMAND_WRITE_DMA_EXT = 0x35;
        const U8 ATA_COMMAND_READ_SECTOR = 0x20;
        const U8 ATA_COMMAND_WRITE_SECTOR = 0x30;
        const U8 ATA_COMMAND_READ_SECTOR_EXT = 0x24;
        const U8 ATA_COMMAND_WRITE_SECTOR_EXT = 0x34;
        ...
        public:
            ...
            virtual eErrorCode IssueCommand_ReadDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) override;
            virtual eErrorCode IssueCommand_WriteDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) override;
            virtual eErrorCode IssueCommand_ReadSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count) override;
            virtual eErrorCode IssueCommand_WriteSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count) override;
            virtual eErrorCode IssueCommand_ReadSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) override;
            virtual eErrorCode IssueCommand_WriteSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) override;
        };
    }
}
