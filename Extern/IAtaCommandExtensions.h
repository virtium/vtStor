...
namespace vtStor
{
    ...
    public:
        ...
        virtual eErrorCode IssueCommand_ReadDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) = 0;
        virtual eErrorCode IssueCommand_WriteDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) = 0;
        virtual eErrorCode IssueCommand_ReadSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count) = 0;
        virtual eErrorCode IssueCommand_WriteSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count) = 0;
        virtual eErrorCode IssueCommand_ReadSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) = 0;
        virtual eErrorCode IssueCommand_WriteSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count) = 0;
