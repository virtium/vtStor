...
namespace vtStor
{
    namespace Ata
    {
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_ReadDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_READ_DMA_EXT;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_WriteDmaExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_WRITE_DMA_EXT;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_ReadSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_READ_SECTOR;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_WriteSector(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U32 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_WRITE_SECTOR;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_ReadSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_READ_SECTOR_EXT;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
        ...
        eErrorCode cAtaCommandExtensions::IssueCommand_WriteSectorExt(std::shared_ptr<IDrive> Drive, U32 CommandType, std::shared_ptr<IBuffer> Data, U64 Lba, U32 Count)
        {
            std::shared_ptr<IBuffer> commandDescriptor = std::make_shared<cBuffer>(cCommandDescriptorAta::SIZE_IN_BYTES);
            cCommandDescriptorAta commandDescriptorVersion1 = cCommandDescriptorAta::Writer(commandDescriptor);

            StorageUtility::Ata::uCommandFields& commandFields = commandDescriptorVersion1.GetCommandFields();
            commandFields.InputFields.Command = ATA_COMMAND_WRITE_SECTOR_EXT;
            commandFields.InputFields.Lba = Lba;
            commandFields.InputFields.Count = Count;
            commandFields.InputFields.ChsMode = 0;
